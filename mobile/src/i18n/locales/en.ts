export default {
  ...
  serviceHub: {
    ...
    requestHint:
      'Write what you need so reception or sales can follow up. Requests are processed by the club.',
    ...
    pickStaffFirst: 'Select a team member from the row above first.',
    ...
    massage: {
      ...
      staffEmpty: 'No therapists listed yet. They will appear when your club adds them.',
    },
  },
  eventsTab: {
    title: 'Club events',
