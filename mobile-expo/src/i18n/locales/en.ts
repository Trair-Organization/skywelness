export default {
  ...
  home: {
    ...
    noPackagesDesc: 'Contact your club reception or send a package request to get started.',
    noTrainers: 'No trainers found',
    noTrainersDesc: 'Your club has no registered trainers yet.',
    noEvents: 'No upcoming events',
    noEventsDesc: 'New events will appear here when added.',
    noReservations: 'No reservations yet',
    noReservationsDesc: 'Pick a trainer and time slot to book your first session.',
    noUpcomingEvents:
  ...
  registration: {
    ...
    partnerFormTitle: 'Partner (Corporate) Application',
    partnerFormSubtitle:
      'Share your club/company details and our corporate onboarding team will contact you shortly.',
    partnerCompanySection: 'Company Information',
    partnerCompanyName: 'Company / Club Name',
    partnerCompanyNamePh: 'e.g. Wellness Group',
    partnerClubCount: 'Number of Branches (optional)',
    partnerClubCountPh: 'e.g. 2',
    partnerWebsite: 'Website (optional)',
    partnerWebsitePh: 'https://...',
    partnerContactSection: 'Contact Person',
    partnerContactName: 'Contact Full Name',
    partnerContactNamePh: 'e.g. Jane Doe',
    partnerNotes: 'Notes (optional)',
    partnerNotesPh: 'Onboarding expectations, active cities, operation notes...',
    partnerLogoUpload: 'Upload business logo',
    partnerLogoUploading: 'Uploading logo...',
    partnerLogoChange: 'Change business logo',
    partnerLogoUploadFailed: 'Business logo upload failed.',
    partnerSubmit: 'Submit partner application',
    partnerSubmitFailed: 'Partner application could not be submitted.',
    partnerRequiredError: 'Please complete required fields (company, contact, email, phone, city).',
    partnerSuccessTitle: 'Partner application received',
    partnerSuccessBody: 'Our corporate onboarding team will contact you soon.',
  },
  register: {
    section: 'Register',
  ...
  trainerRegister: {
    ...
    title: 'Independent trainer application',
    subtitle: 'Create your trainer workspace. Platform admin will review your application.',
    city: 'City',
    bio: 'Bio',
    ...
    commaHint: 'Separate items with comma',
    bioHint: 'Describe your expertise, coaching style, and focus areas.',
    bioMinLength: 'Bio must be at least 20 characters.',
    experienceYears: 'Years of experience (optional)',
    socialLinks: 'Social links (optional)',
    pricingNote: 'Session type / pricing note (optional)',
    pricingNoteHint: 'e.g. Online PT / 60-minute 1:1 session',
    photoUpload: 'Upload profile photo',
    photoUploading: 'Uploading photo...',
    photoChange: 'Change profile photo',
    photoUploadFailed: 'Photo upload failed. Please try again.',
    submit: 'Send trainer application',
    submitting: 'Sending...',
  ...
  network: {
    ...
    emptyTrainers: 'No connected trainer yet.',
    connectTrainer: 'Connect to trainer',
    emptyConnectable: 'No connectable trainers for this filter.',
    connectAction: 'Create connection',
    connectOk: 'Trainer connection created.',
    connectFail: 'Could not connect trainer.',
    scope: {
      all: 'All',
      club: 'Club',
    ...
    emptyStudents: 'No connected student yet.',
    notes: 'Notes',
    newNote: 'New student note',
    addNote: 'Add note',
    noteFail: 'Could not add note.',
    loadFailed: 'Could not load network data.',
    requestLesson: 'Request private lesson',
    requestLessonTitle: 'Private lesson request',
    requestLessonHint:
      'Tell the trainer your goals and availability. We will notify you once the club admin assigns the package.',
    requestSessionTypeLabel: 'Session type',
    requestSessionPersonal: 'Personal training',
    requestSessionMassage: 'Massage',
    requestMessageLabel: 'Message to trainer (optional)',
    requestMessagePh: 'Your goals, frequency, available hours…',
    requestSubmit: 'Send request',
    requestSending: 'Sending…',
    requestOk: 'Request received! We will let you know once the club admin approves the package.',
    requestFail: 'Could not send request. Please try again later.',
  },
  profile: {
