export default {
  ...
  network: {
    ...
    emptyConnectable: 'Bu filtrede bağlanılabilir eğitmen bulunmuyor.',
    ...
    tags: {
      independent: 'Bağımsız eğitmen',
      clubTrainer: 'Kulüp eğitmeni',
    },
    ...
    requestLesson: 'Özel ders iste',
    requestLessonTitle: 'Özel ders talebi',
    requestLessonHint:
      'Eğitmenin sana özel program oluşturması için tercih ve hedeflerini yaz. Kulüp yöneticisi paketi tanımladığında bildirim göndereceğiz.',
    requestSessionTypeLabel: 'Seans tipi',
    requestSessionPersonal: 'Özel ders',
    requestSessionMassage: 'Masaj',
    requestMessageLabel: 'Eğitmene mesajın (opsiyonel)',
    requestMessagePh: 'Hedeflerin, sıklığın, müsait saatlerin…',
    requestSubmit: 'Talebi gönder',
    requestSending: 'Gönderiliyor…',
    requestOk: 'Talebin alındı! Yönetim paketi onayladığında bilgilendireceğiz.',
    requestFail: 'Talep gönderilemedi. Daha sonra yeniden dene.',
  },
  profile: {
