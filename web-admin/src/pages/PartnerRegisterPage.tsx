...
export function PartnerRegisterPage() {
  ...
  async function submitTrainer(e: FormEvent) {
    e.preventDefault();
    setError(null);
    if (trainer.password !== trainer.passwordConfirm) {
    ...
    if (offersSessionTypes.length === 0) {
      setError('En az bir hizmet türü seçin.');
      return;
    }
    if (trainer.bio.length < 20) {
            ...
            <div className="auth-success">
              ...
              <p>
                {partnerType === 'corporate'
                  ? 'Kurumsal partner başvurunuz incelemeye alınmıştır. En kısa sürede sizinle iletişime geçeceğiz.'
                  : 'Eğitmen başvurunuz incelemeye alınmıştır. Onay sonrası giriş yapabilirsiniz.'}
              </p>
      ...
      <div className="public-shell">
        ...
        <div className="auth-container">
          <div className="auth-card auth-card-wide">
            ...
            <p className="auth-subtitle">
              Spor salonu, wellness merkezi veya fitness stüdyosu bilgilerinizi girin. Onay sonrası
              admin paneliniz aktif olacak.
            </p>
            ...
            <form className="auth-form" onSubmit={submitCorporate}>
                    ...
                    <label className="logo-dropzone">
                      ...
                      {logoUploading ? (
                        ...
                        <>
                          ...
                          <span className="photo-text">Logo Yükle</span>
                        </>
                      )}
                    </label>
                  )}
              ...
              <div className="auth-row">
                ...
                <label>
                  ...
                  <input
                    type="text"
                    value={corp.contactName}
                    onChange={(e) => updateCorp('contactName', e.target.value)}
                    required
                    minLength={2}
                  />
                </label>
              ...
              <div className="auth-row">
                <label>
                  ...
                  <select
                    value={corp.city}
                    onChange={(e) => {
                      updateCorp('city', e.target.value);
                      updateCorp('district', '');
                    }}
                    required
                    style={{
                ...
                <label>
                  ...
                  <select
                    value={corp.district || ''}
                    onChange={(e) => updateCorp('district', e.target.value)}
                    disabled={!corp.city}
                    style={{
                      width: '100%',
                      padding: '0.75rem',
              ...
              <div className="auth-row">
                <label>
                  ...
                  <input
                    type="number"
                    value={corp.clubCount}
                    onChange={(e) => updateCorp('clubCount', e.target.value)}
                    min={1}
                    placeholder="1"
                  />
                </label>
              ...
              <label>
                ...
                <input
                  type="url"
                  value={corp.website}
                  onChange={(e) => updateCorp('website', e.target.value)}
                  placeholder="https://..."
                />
              </label>
              <label>
          ...
          <form className="auth-form" onSubmit={submitTrainer}>
            ...
            <div className="auth-row">
              <label>
                ...
                <input
                  ...
                  onChange={(e) => updateTrainer('firstName', e.target.value)}
                  required
                />
              </label>
              <label>
                ...
                <input
                  ...
                  onChange={(e) => updateTrainer('lastName', e.target.value)}
                  required
                />
              </label>
            </div>
            <div className="auth-row">
              ...
              <label>
                ...
                <input
                  type="tel"
                  value={trainer.phone}
                  onChange={(e) => updateTrainer('phone', e.target.value)}
                  required
                  placeholder="+90 5XX XXX XX XX"
                />
              </label>
            ...
            <div className="auth-row">
              <label>
                ...
                <input
                  ...
                  onChange={(e) => updateTrainer('username', e.target.value)}
                  required
                  minLength={3}
            ...
            <div className="auth-row">
              <label>
                ...
                <select
                  value={trainer.city}
                  onChange={(e) => {
                    updateTrainer('city', e.target.value);
                    updateTrainer('district', '');
                  }}
                  required
                  style={{
                    width: '100%',
              ...
              <label>
                <span>İlçe</span>
                <select
                  value={trainer.district || ''}
                  onChange={(e) => updateTrainer('district', e.target.value)}
                  disabled={!trainer.city}
                  style={{
                    width: '100%',
                    padding: '0.75rem',
                    borderRadius: 8,
                ...
                >
                  <option value="">Seçin...</option>
                  {trainer.city &&
                    getDistricts(trainer.city).map((d) => (
                      <option key={d} value={d}>
                        {d}
                      </option>
                    ))}
            ...
            <label>
              ...
              <textarea
                ...
                minLength={20}
                rows={4}
                placeholder="Kendinizi tanıtın, deneyimlerinizi ve yaklaşımınızı anlatın..."
              />
            </label>
            ...
            <div className="chips-section">
              ...
              <div className="cert-input-row">
                ...
                />
                <button type="button" className="btn-outline cert-add-btn" onClick={addCert}>
                  Ekle
                </button>
              </div>
            ...
            <div className="auth-row">
              <label>
                ...
                <input
                  ...
                  onChange={(e) => updateTrainer('experienceYears', e.target.value)}
                  min={0}
                  placeholder="5"
                />
              </label>
              <label>
                ...
                <input
                  type="text"
                  value={trainer.pricingNote}
                  onChange={(e) => updateTrainer('pricingNote', e.target.value)}
                  placeholder="ör: Seans başı 500₺"
                />
              </label>
            </div>
            ...
            <label>
              ...
              <input
                type="text"
                value={trainer.preferredClubSubdomain}
                onChange={(e) => updateTrainer('preferredClubSubdomain', e.target.value)}
                placeholder="Kulüp kodu (ör: skyland)"
              />
              <small className="auth-hint">
                Bir kulübe bağlı çalışmak istiyorsanız kulüp kodunu girin.
              </small>
            </label>
            ...
            <div className="auth-row">
              <label>
                ...
                <input
                  ...
                  onChange={(e) => updateTrainer('password', e.target.value)}
                  required
                  minLength={8}
                />
              </label>
              <label>
                ...
                <input
                  type="password"
                  value={trainer.passwordConfirm}
                  onChange={(e) => updateTrainer('passwordConfirm', e.target.value)}
                  required
                />
              </label>
            </div>
