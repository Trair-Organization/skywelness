...
export function PackageTypesPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const data = await apiJson<PackageType[]>('/admin/package-types');
      setTypes(data);
    } catch (e) {
    ...
    <div className="dashboard-page">
      <div className="dashboard-header">
        <div>
          ...
          <p className="dashboard-subtitle">Satışa sunduğunuz PT ve masaj paketlerini yönetin</p>
        </div>
        <button
          ...
          {types.map((pt) => (
            <div key={pt.id} className="service-card">
              ...
              <div className="service-meta">
                ...
                <span className="service-price">₺{Number(pt.price).toLocaleString('tr-TR')}</span>
              </div>
