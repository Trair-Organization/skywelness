export default {
  ...
  superAdmin: {
    ...
    dashboard: {
      ...
      pendingMembers: 'Pending members',
      pendingTrainerApplications: 'Pending trainer applications',
      manageTitle: 'Global management',
      tenantsLink: 'Manage clubs →',
      usersLink: 'Manage users →',
      trainersLink: 'Manage trainers →',
      applicationsLink: 'Review trainer applications →',
      auditLink: 'Open audit log →',
    },
    tenants: {
      title: 'All clubs',
      name: 'Club name',
    ...
    users: {
      ...
      updateError: 'Could not update user status',
    },
    trainers: {
      title: 'All trainers',
      scopeLabel: 'Trainer type',
      scopeAll: 'All',
      scopeClub: 'Club trainer',
      scopeIndependent: 'Independent trainer',
      name: 'Name',
      email: 'Email',
      type: 'Type',
      typeClub: 'Club',
      ...
      services: 'Services',
      actions: 'Actions',
      assignError: 'Could not reassign trainer',
    },
    audit: {
      title: 'Audit log',
      when: 'When',
